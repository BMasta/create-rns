...
* Data and assets: block definitions still come from KubeJS block startup scripts, mining recipes now come from KubeJS server recipe scripts and serialize through the normal `create_rns:mining` recipe codec, and deposit specs, structures, processors, structure lang, structure tags, and optional structure sets come from the separate deposit-structure startup event plus KubeJS-generated data.
