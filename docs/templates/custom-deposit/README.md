...
2. Add/replace a mining recipe for each deposit in `kubejs/server_scripts/main.js`
3. Add a texture for each new deposit block in `assets/<your namespace>/textures/block/<your block>.png`.
