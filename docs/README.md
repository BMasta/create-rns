...
* Tweak mining recipes
* Create custom catalysts

Yoink and twist, as they say. Here are the templates for common use cases:
* Select which deposits should be enabled, and how often they should spawn [[click](templates/configure-default-deposits)]
* Tweak a mining recipe for a deposit [[click](templates/tweak-mining-recipe)]
