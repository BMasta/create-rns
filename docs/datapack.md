...
| Feature                                                      | <div style="width: 450px;">Datapack path pattern</div>      | Notes       |
|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| Mining recipes (`create_rns:mining`)                         | `data/<namespace>/recipe/*.json`                                                                                                                                                                                                                                                                                                                                                                                      | Controls what you get when mining a deposit, how many resources it has on average (with finite deposits turned on), what happens when it gets depleted, and how the recipe is rendered in JEI.                                                                         |
| Catalyst definitions (custom registry `create_rns:catalyst`) | `data/<namespace>/create_rns/catalyst/*.json`                                                                                                                                                                                                                                                                                                                                                                         | Defines catalyst requirement sets referenced by mining yields.                                                                                                                                                                                                         |
| Deposit world generation                                     | `data/<namespace>/create_rns/deposit_spec/*.json`<br>`data/<namespace>/worldgen/structure/*.json`<br>`data/<namespace>/worldgen/template_pool/<pool>/start.json`<br>`data/<namespace>/worldgen/structure_set/*.json`<br>`data/<namespace>/worldgen/processor_list/*.json`<br>`data/<namespace>/tags/worldgen/biome/*.json`<br>`data/<namespace>/tags/worldgen/structure/*.json`<br>`data/<namespace>/structure/*.nbt` | Allows adding new deposit structures, modifying existing ones, mapping a deposit scanner icon and name to a structure, controlling the frequency of spawns and spread of deposit structures, which biomes they appear in, and which structures are tagged as deposits. |
