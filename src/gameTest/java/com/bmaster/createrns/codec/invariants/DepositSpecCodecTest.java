...
public class DepositSpecCodecTest {
    ...
    public void parsesDepositSpecAndInitializesDirectIcons(GameTestHelper helper) {
        ...
        helper.assertValueEqual(spec.structure, IRON_STRUCTURE_ID, "deposit structure id");
        helper.assertValueEqual(spec.structureKey().location(), IRON_STRUCTURE_ID, "deposit structure key id");
