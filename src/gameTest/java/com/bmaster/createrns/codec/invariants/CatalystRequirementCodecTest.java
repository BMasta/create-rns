...
public class CatalystRequirementCodecTest {
    ...
    public void attachmentRequirementParsesSingleBlock(GameTestHelper helper) {
        ...
        helper.assertValueEqual(attachmentRequirement.count, 3, "attachment count");
        helper.assertValueEqual(attachmentRequirement.attachment.size(), 1, "attachment block count");
    ...
    public void attachmentRequirementParsesBlockList(GameTestHelper helper) {
        ...
        var attachmentRequirement = CodecHelper.assertInstanceOf(helper, AttachmentCatalystRequirement.class,
                requirement, "parsed catalyst requirement");
        helper.assertValueEqual(attachmentRequirement.count, 3, "attachment count");
        helper.assertValueEqual(attachmentRequirement.attachment.size(), 2, "attachment block count");
        CodecHelper.assertSame(helper, Blocks.STONE, attachmentRequirement.attachment.get(0).value(),
    ...
    public void attachmentRequirementParsesBlockTag(GameTestHelper helper) {
        ...
        var attachmentRequirement = CodecHelper.assertInstanceOf(helper, AttachmentCatalystRequirement.class,
                requirement, "parsed catalyst requirement");
        helper.assertValueEqual(attachmentRequirement.count, 2, "attachment count");
        ...
        helper.assertValueEqual(tagKey.location(), BlockTags.PLANKS.location(), "attachment tag key");
    ...
    public void fluidRequirementParsesWithFluidStackPayload(GameTestHelper helper) {
        ...
        helper.assertValueEqual(fluidRequirement.fluidStack.getAmount(), 20, "required fluid amount");
        ...
        helper.assertValueEqual(tank.getFluidAmount(), 40, "fluid amount after simulated catalyst usage");
        ...
        helper.assertValueEqual(tank.getFluidAmount(), 20, "fluid amount after executing catalyst usage");
        ...
        helper.assertValueEqual(wrongFluidTank.getFluidAmount(), 40,
