...
public final class CatalystRequirementType<T extends CatalystRequirement> {
    ...
    public static final CatalystRequirementType<FluidCatalystRequirement> FLUID =
            register("fluid", FluidCatalystRequirement.CODEC);
    public static final CatalystRequirementType<AttachmentCatalystRequirement> ATTACHMENT =
            register("attachment", AttachmentCatalystRequirement.CODEC);
    ...
    private CatalystRequirementType(String name, Codec<T> codec) {
        this.name = name;
        this.codec = codec;
    }
    ...
    private static <T extends CatalystRequirement> CatalystRequirementType<T> register(String name, Codec<T> codec) {
        var type = new CatalystRequirementType<>(name, codec);
