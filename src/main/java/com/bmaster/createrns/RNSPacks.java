...
public class RNSPacks {
    ...
    public static DynamicDatapack MAIN_PACK = DynamicDatapack.createDatapack("dynamic_data")
            ...
            .addContent(DynamicDatapackContent.depositBiomeTag(DepositDimension.OVERWORLD, false))
            .addContent(DynamicDatapackContent.depositBiomeTag(DepositDimension.NETHER, false))
            ...
            // Create dynamically registered deposit specs.
            .addContent(DynamicDatapackContent.depositSpecs())
            ...
            .addContent(DynamicDatapackContent.depositStructureSet(DepositDimension.OVERWORLD,
                    DEFAULT_SEPARATION, DEFAULT_SPACING, SALT))
            .addContent(DynamicDatapackContent.depositStructureSet(DepositDimension.NETHER,
    ...
    public static DynamicDatapack NO_DEPOSIT_PACK = DynamicDatapack.createDatapack("no_deposit_worldgen")
            ...
            .addContent(DynamicDatapackContent.depositBiomeTag(DepositDimension.OVERWORLD, true))
            .addContent(DynamicDatapackContent.depositBiomeTag(DepositDimension.NETHER, true))
            .register();
