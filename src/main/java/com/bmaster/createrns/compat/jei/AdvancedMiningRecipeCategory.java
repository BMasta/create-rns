...
public class AdvancedMiningRecipeCategory extends MiningRecipeCategory<AdvancedMiningRecipe> {
    public static final RecipeType<RecipeHolder<AdvancedMiningRecipe>> JEI_RECIPE_TYPE = RecipeType.createRecipeHolderType(
            ResourceLocation.fromNamespaceAndPath(CreateRNS.MOD_ID, MiningLevel.ADVANCED.getRecipeID()));
