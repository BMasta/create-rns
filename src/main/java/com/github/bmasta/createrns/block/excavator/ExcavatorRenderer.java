...
public class ExcavatorRenderer extends KineticBlockEntityRenderer<ExcavatorBlockEntity> {
    public ExcavatorRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(ExcavatorBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
